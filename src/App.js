...
function App() {
  ...
  useEffect(() => {
    Axios.get('https://curd-basic-sever.onrender.com/read')
    .then((response) => {
  ...
  const addFoodData = () =>{
    Axios.post("https://curd-basic-sever.onrender.com/insert",
    {
      foodName:foodName, 
...
const UpdateFoodData = (id) =>{
    Axios.put("https://curd-basic-sever.onrender.com/update", {
      id:id, newFoodName:newFoodName})
  }

  const DeleteData = (id) =>{
    Axios.delete(`https://curd-basic-sever.onrender.com/delete/${id}`)
